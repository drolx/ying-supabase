...
<template>
  <div class="h-100 w-100 pt-8 d-flex align-center justify-center">
    ...
    <v-card v-else min-width="350" prepend-icon="mdi-account" :title="`Modify Category - ${item.name}`">
      <v-card-text>
        <v-row dense>
          <v-col cols="12">
          ...
          <v-col cols="12">
            <v-textarea label="Description" v-model="item.description" variant="filled" auto-grow></v-textarea>
          </v-col>
        </v-row>
      </v-card-text>
      <v-divider></v-divider>

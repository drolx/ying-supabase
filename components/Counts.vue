...
import { useArticles } from '@/stores/articles';  // Import Pinia store for articles
import { useCategories } from '@/stores/categories';  // Import Pinia store for categories
import { useTags } from '@/stores/tags';  // Import Pinia store for tags
import { useSources } from '@/stores/sources';  // Import Pinia store for sources
...
// Fetch the data from each store when the component is mounted
onMounted(() => {
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-6 rounded-lg shadow-lg" :style="{ backgroundColor: '#E3F2FD' }">
          <v-row align="center" justify="center" class="d-flex my-4 gap-8">
            ...
            <p class="font-bold text-h5">{{ articlesStore.totalItems }}</p> <!-- Use totalItems from Pinia store -->
          </v-row>
          <v-divider></v-divider>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-6 rounded-lg shadow-lg" :style="{ backgroundColor: '#F1F8E9' }">
          <v-row align="center" justify="center" class="d-flex my-4 gap-8">
            ...
            <p class="font-bold text-h5">{{ categoriesStore.totalItems }}</p> <!-- Use totalItems from Pinia store -->
          </v-row>
          <v-divider></v-divider>
          <v-row justify="center" class="d-flex my-4">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-6 rounded-lg shadow-lg" :style="{ backgroundColor: '#FFEBEE' }">
          <v-row align="center" justify="center" class="d-flex my-4 gap-8">
            ...
            <p class="font-bold text-h5">{{ tagsStore.totalItems }}</p> <!-- Use totalItems from Pinia store -->
          </v-row>
          <v-divider></v-divider>
          <v-row justify="center" class="d-flex my-4">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-6 rounded-lg shadow-lg" :style="{ backgroundColor: '#FFF3E0' }">
          <v-row align="center" justify="center" class="d-flex my-4 gap-8">
            ...
            <p class="font-bold text-h5">{{ sourcesStore.totalItems }}</p> <!-- Use totalItems from Pinia store -->
          </v-row>
          <v-divider></v-divider>
          <v-row justify="center" class="d-flex my-4">
